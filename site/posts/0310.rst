...
Yo pensé en un árbol con una letra por nodo. Al toque, le sugirieron que usase un árbol Trie. Yo, que como no soy informático no conozco muchos nombres, fui a revisar qué era un árbol Trie (`acá <http://es.geocities.com/lenguajenatural/indexacion.htm>`_ hay una explicación piola, `acá <http://es.wikipedia.org/wiki/Trie>`_ una más formal).
...
.. image:: http://farm4.static.flickr.com/3488/3257154185_3687d9cef0_o.png
...
.. image:: http://farm4.static.flickr.com/3302/3257983600_873d4575e3_o.png
