...
.. image:: http://farm2.static.flickr.com/1427/533412941_e39d3aff40_o.jpg
...
Pueden bajar el juego de `acá <http://media.pyweek.org/dl/3/PyAr2/typuspocus-v1.tar.gz>`_. Para probarlo, tienen que tener Python instalado (lo pueden bajar de `acá <http://www.python.org/download/releases/2.5/>`_) y PyGame (de `acá <http://www.pygame.org/download.shtml>`_).
