...
Esto no es mío (yo estoy enamorado de otra M.). Es de `Pinchilón Fonseca <http://pinchilonfonseca.wordpress.com/>`_:
...
¡Cómo escribe el cabrón! Me encanta. Ese párrafo es de una serie de posts que se llama "María", `aquí está el último capítulo <http://pinchilonfonseca.wordpress.com/2008/06/29/maria-parte-8-final/>`_ (y enlaces a todos los otros, por eso les paso ese link... obviamente lo tienen que leer en orden).
