...
El archivo completo es `spdx.c <http://www.taniquetil.com.ar/facundo/pygo/spdx.c>`_, paso a explicarlo haciendo antes la aclaración que es para Python 2 (que es lo que tenemos hoy en ese servicio), pero si fuera para Python 3 sería muy parecido (la idea es la misma, cambian algunos nombres, `revisen acá <https://docs.python.org/3/extending/extending.html>`_).
...
El archivo completo es `spdxlib.go <http://www.taniquetil.com.ar/facundo/pygo/spdxlib.go>`_.
