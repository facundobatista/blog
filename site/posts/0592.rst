...
Les había comentado `en otra oportunidad <http://www.taniquetil.com.ar/plog/post/1/548>`_ que estaba bajando automáticamente un montón de videoclips, por torrent.
...
Para administrarlos prolijos, me hice `un programita <http://www.taniquetil.com.ar/homedevel/devel/collect_video_info.py>`_ que me arma `un reporte de todos los videos <http://www.taniquetil.com.ar/facundo/bdvfiles/videoclips.html>`_, indicando intérprete, tema, la duración, cuanto pesan, y el formato, más info de la parte de video y del audio.
