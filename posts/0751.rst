...
- "Robótica educativa con software y hardware libre... y Python!", de Valentín Basel, que mostró cómo armaron el `proyecto Icaro <https://roboticaro.org/>`_ de forma que los niños puedan hacer cosas con componentes baratos o reciclado y aprender a programar en el camino.
...
Hasta donde sé se grabaron todas las charlas, así que avisaré cuando estén subidas. Y acá tienen `fotos mías <https://www.dropbox.com/sh/zurxfqpdda5hwxr/AAAslKp59Wm2FQbFHQzKSST8a?dl=0>`_ y `las que sacó Yami <https://www.flickr.com/photos/70871182@N04/sets/72157662945453988>`_ (incluyendo la grupal que reproduzco arriba).
