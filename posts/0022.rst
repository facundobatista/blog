...
Se llevó a cabo la quinta reunión de `PyAr <https://python.org.ar/>`_ con total éxito. Como Mariano (escriba oficial) estaba de vacaciones, recayó en mí la tarea de contarles qué hicimos.
