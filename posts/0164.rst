...
Hubieron un par de horas en que no encontré ninguna charla interesante, y luego arrancaron las lightning talks. Las dos más interesantes fueron la de `twill <http://ivory.idyll.org/articles/twill-and-wsgi_intercept.html>`_ (una aplicación para testear aplicaciones web) y `Chandler <http://chandler.osafoundation.org/>`_ (realmente está quedando muy bien; está super completo, sin embargo van por la versión 0.5, y es bastante usable... ¿estamos viendo otro futuro suceso como Mozilla?)
