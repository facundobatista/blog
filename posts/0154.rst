...
¡Se viene el primer merchandising oficial de Python Argentina! En el beta del nuevo sitio de PyAr estamos anotando cuantas queremos y de que talle (**Actualización:** Esa página beta ya no existe más, porque el sitio de PyAr está levantado y funcionando hace rato; la página de las remeras es `esta <https://www.python.org.ar/Remeras>`_).
