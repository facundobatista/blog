...
- `Evolution of Parallel Cellular Machines <https://www.cs.bgu.ac.il/~sipper/publications/epcm1.pdf>`_ (Moshe Sipper): Completísimo (213 páginas) documento sobre máquinas celulares y el acercamiento a la programación mediante varias en paralelo.
...
- `How-To Guide for Descriptors <https://www.pkimber.net/howto/python/conference/descriptors.html>`_ (Raymond Hettinger): Muy buen tutorial de cómo usar descriptores en Python.
