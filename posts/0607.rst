...
Pueden ver los cálculos en `este PDF <http://www.taniquetil.com.ar/bdvfiles/costoauto1.pdf>`_, pero si quieren les dejo el `notebook ipython que armé <http://www.taniquetil.com.ar/bdvfiles/costoauto1.ipynb>`_, para que jueguen con él (lo bajan y hacen ``ipython notebook costoauto1.ipynb``).
