...
El más ajustado al tiempo es el `Seminario de Python <http://www.taniquetil.com.ar/bdvfiles/cursosAbiertos.html>`_. Claro, llegó Julio y arrancó el seminario, que no es más que un curso con mucha gente :)
