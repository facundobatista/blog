...
Alecu y Dave van a dar una charla de la OLPC este finde en `Python Santa Fe <http://www.pythonsantafe.com.ar/>`_, y ya tenemos pensado meternos a participar en el desarrollo de estas máquinas. Por lo pronto, vamos a migrar `Typus Pocus </posts/0210>`_, :)
