...
Como comenté en otro `post </posts/0055>`_, descubrí en una de las charlas al `SimpleXMLRPCServer <http://www.python.org/doc/2.4/lib/module-SimpleXMLRPCServer.html>`_. Basicamente lo que hace este pedazo de software es "publicar" via http, en el puerto que uno quiera, una determinada función.
