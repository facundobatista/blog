...
Y también trabajé en la `CDPedia <http://code.google.com/p/cdpedia/>`_, un proyecto de `PyAr <https://www.python.org.ar>`_ que teníamos bastante abandonado, pero que quiero empujar para que salga este nuevo año.
