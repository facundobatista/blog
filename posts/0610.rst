.. title: La estructura de un proyecto: ejemplo Encuentro
...
- ``qtreactor``: El módulo de integración entre Qt (el framework de interfaz gráfica que `estoy usando </posts/0603>`_) y Twisted (una biblioteca asincrónica que uso para trabajar con la red).
