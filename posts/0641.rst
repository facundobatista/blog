...
A `Linkode <http://linkode.org/>`_, lo tengo abandonadazo, pero ya lo voy a retomar. Y también le estoy tratando de meter algo de tiempo a `Preciosa <https://github.com/mgaitan/preciosa>`_, la aplicación de Martín para que no nos mientan con los precios y poder comprar más barato.
