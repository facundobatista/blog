.. title: Técnica de fuego para asado
...
Pueden ver si quieren `todas las fotos <https://www.dropbox.com/sh/muufcxyqcg096zw/AAAcR-zLatAtxgqCoMugq1Sla?dl=0>`_ de la secuencia (obviamente en orden), de las cuales incluí algunas en este post.
...
Para terminar, y a modo de bonus track, les dejo para que disfruten el audio del último tema del segundo disco de `Demoliendo Tangos <http://demoliendotangos.blogspot.com/>`_, que se llama, justamente, `Carne Argenta <https://www.youtube.com/watch?v=wKPJiEdBLv0>`_.
