...
Más allá de esas charlas, tendremos muchas que damos distintos miembros de Python Argentina, `miren, miren <http://www.python.org.ar/wiki/Eventos/Conferencias/8JRSL>`_. Yo voy a dar "Introducción a Python" (mañana mismo a la 11hs, aula 3.5), y "Entendiendo Unicode" (también mañana miércoles, a las 14hs, aula 10.1).

El jueves tendremos la reunión de PyAr número 30 (¡¡30!!), a las 19hs. Tenemos el lugar hasta las 22, pero luego la podemos seguir en otro lado si tenemos resto físico y mental... Más info, `acá <http://www.python.org.ar/wiki/Eventos/Reuniones/ProximaReunion>`_ (¡anótense!).
