...
- Geek (`wikipedia <http://en.wikipedia.org/wiki/Geek>`__, `jargon file <http://www.catb.org/jargon/html/G/geek.html>`__)

- Nerd (`wikipedia <http://en.wikipedia.org/wiki/Nerd>`__, `jargon file <http://www.catb.org/jargon/html/N/nerd.html>`__)

- Techie (`wikipedia <http://en.wikipedia.org/wiki/Techie>`__)
