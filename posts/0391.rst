...
No vamos a discutir toda la organización en la `lista de PyAr <http://www.python.org.ar/lista/>`_, sino que abrimos `otra <https://listas.usla.org.ar/cgi-bin/mailman/listinfo/pyconar-admin>`_, a la cual pueden anotarse todos lo que les interese laburar en la organización del evento.
