...
De ahí me fui a una charla de la `Universitat Oberta de Catalunya <http://www.uoc.es/web/esp/index.html>`_, que están promocionando un `Master en Software Libre <http://www.uoc.edu/masters/oficiales/master_oficial_software_libre/master_oficial_software_libre_plan.htm>`_, el cual es bastante interesante, le voy a pegar una mirada con más detalle. Una característica importante del master es que es totalmente a distancia. Es caro, principalmente porque está en euros, pero como uno no tiene que viajar, es solamente el costo del mismo.
...
.. image:: http://farm4.static.flickr.com/3256/3257153145_d9ac067f72_o.jpg
