...
Agradecemos la contribución de todos en la difusión de este llamado y del evento en si mediante los banners diseñados para tal fin y que se encuentran `aquí <http://ar.pycon.org/2009/helping/publicize/>`__.

Las charlas deben ser ingresadas para su aprobación `aquí <http://ar.pycon.org/2009/conference/proposals/submit/>`__. La fecha límite de envío de charlas es el Lunes 29 de Junio inclusive. En caso de consultas o inconvenientes, `envianos un mail <mailto:charlas@python.org.ar>`_.
