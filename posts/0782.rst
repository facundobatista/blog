...
En otras palabras, asumiré un conocimiento de las estructuras más simples y usadas del lenguaje (que voy a repasar de forma breve) y voy a profundizar en otros temas del lenguaje y sus bibliotecas. El `programa <http://www.taniquetil.com.ar/facundo/curso-medio-avanzado.html>`_ es super variado, me entusiasmé y metí un montón de temas, así que el ritmo de las clases va a ser interesante. Vengan despiertes :p
...
Acá están `todos los detalles del curso <http://www.taniquetil.com.ar/facundo/curso-medio-avanzado.html>`_.
