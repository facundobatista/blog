...
No es la `primera vez </posts/0007>`_ que menciono a `Miguel <http://primates.ximian.com/~miguel/activity-log.php>`_ o `Nat <http://nat.org/blog>`_, pero quiero destacar algo que me llama la atención.
