...
No es la `primera vez <http://www.taniquetil.com.ar/plog/post/1/7>`_ que menciono a `Miguel <http://primates.ximian.com/~miguel/activity-log.php>`_ o `Nat <http://nat.org/blog>`_, pero quiero destacar algo que me llama la atención.
...
Agregué en la barra de enlaces, en Frecuentes (a la derecha abajo), el blog de `Nat <http://nat.org/blog>`_. Y aprovechando que Laura finalmente se decidió por la dirección final, punteros tanto a su `blog <http://lalyum.blogspot.com/>`_ como también a su `flog <http://www.fotolog.net/lalyum/>`_.
