...
No sólo estoy más comprometido con la conferencia personalmente (me tomo el viernes en el laburo y voy a ir ambos días de la conferencia todo el día), sino que también tenemos más presencia, como grupo, con `Python Argentina <https://www.python.org.ar>`_ (vamos a tener una mesa, finalmente tenemos `bandera <https://www.python.org.ar/wiki/Bandera/fotos/>`_ para mostrar, etc.).
